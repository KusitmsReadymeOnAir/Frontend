...
const Posts = () => {
  useEffect(() => {
    axios.get('/board/list').then(() => console.log('success'));
  }, []);
          ...
          <CategoryBtn
            ...
            onClick={() =>
              category === 'design'
                ...
                : (setCategory('design'),
                  setClick([true, false, false, false, false]))
            }
          >
            디자인
          </CategoryBtn>
            ...
            onClick={() =>
              category === 'develop'
                ? (setCategory(''),
                  setClick([false, false, false, false, false]))
                : (setCategory('develop'),
                  setClick([false, true, false, false, false]))
            }
          >
            개발
          </CategoryBtn>
            ...
            onClick={() =>
              category === 'pd'
                ? (setCategory(''),
                  setClick([false, false, false, false, false]))
                : (setCategory('pd'),
                  setClick([false, false, true, false, false]))
            }
          >
            기획
          </CategoryBtn>
          <CategoryBtn
            ...
            onClick={() =>
              category === 'teambuild'
                ? (setCategory(''),
                  setClick([false, false, false, false, false]))
                : (setCategory('teambuild'),
                  setClick([false, false, false, true, false]))
            }
          >
            프로젝트 모집
          </CategoryBtn>
            ...
            onClick={() =>
              category === 'daily'
                ? (setCategory(''),
                  setClick([false, false, false, false, false]))
                : (setCategory('daily'),
                  setClick([false, false, false, false, true]))
            }
          >
            일상
          </CategoryBtn>
